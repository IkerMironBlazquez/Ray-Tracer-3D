#!/bin/sh
#SBATCH --job-name=static_t64
#SBATCH --output=./logs/static_64.txt
#SBATCH --error=./logs/static_64.err
#SBATCH -p stan
...
OUTPUT="./logs/output_static_64.ppm"
echo "=== STATIC PARTITIONER - 64 THREADS ==="
