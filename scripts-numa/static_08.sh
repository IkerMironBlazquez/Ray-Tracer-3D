#!/bin/sh
#SBATCH --job-name=static_t08
#SBATCH --output=./logs/static_08.txt
#SBATCH --error=./logs/static_08.err
#SBATCH -p stan
...
OUTPUT="./logs/output_static_08.ppm"
echo "=== STATIC PARTITIONER - 8 THREADS ==="
