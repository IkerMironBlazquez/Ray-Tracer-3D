#!/bin/sh
#SBATCH --job-name=static_t32
#SBATCH --output=./logs/static_32.txt
#SBATCH --error=./logs/static_32.err
#SBATCH -p stan
...
OUTPUT="./logs/output_static_32.ppm"
echo "=== STATIC PARTITIONER - 32 THREADS ==="
