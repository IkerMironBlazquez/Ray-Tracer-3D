#!/bin/sh
#SBATCH --job-name=simple_t64
#SBATCH --output=./logs/simple_64.txt
#SBATCH --error=./logs/simple_64.err
#SBATCH -p stan
...
OUTPUT="./logs/output_simple_64.ppm"
echo "=== SIMPLE PARTITIONER - 64 THREADS ==="
