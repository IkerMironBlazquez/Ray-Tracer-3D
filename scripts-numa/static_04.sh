#!/bin/sh
#SBATCH --job-name=static_t04
#SBATCH --output=./logs/static_04.txt
#SBATCH --error=./logs/static_04.err
#SBATCH -p stan
...
OUTPUT="./logs/output_static_04.ppm"
echo "=== STATIC PARTITIONER - 4 THREADS ==="
echo "--- Grain: 64 ---"
