#!/bin/sh
#SBATCH --job-name=simple_t128
#SBATCH --output=./logs/simple_128.txt
#SBATCH --error=./logs/simple_128.err
#SBATCH -p stan
...
OUTPUT="./logs/output_simple_128.ppm"
echo "=== SIMPLE PARTITIONER - 128 THREADS ==="
